	...
	public static void main(String[] args) {
		...
		for(int i = 0; i < a2d.length; i++)
			for(int j = 0; j < a2d[i].length; j++)
				if(a2d[i][j] == max2d)
					System.out.println(i + " " + j);// prints location maximal number
		int min2d = findMin2d(a2d);// minimal value is found
		System.out.println(min2d);
		for(int i = 0; i < a2d.length; i++)
			for(int j = 0; j < a2d[i].length; j++)
				if(a2d[i][j] == min2d)
					System.out.println(i + " " + j);// prints location minimal number
		for(int i = 0; i < a2d.length; i++)
			System.out.println("sum of row " + i + " is " + sumRow(a2d,i));//prints sums of all rows
		for(int j = 0; j < a2d[0].length; j++)
			System.out.println("sum of column " + j + " is " + sumCol(a2d,j));//prints sums of all columns
		...
		output2d(a2d);
		swappingUpDownMainDiagonal(a2d);// swapps again to restart array
