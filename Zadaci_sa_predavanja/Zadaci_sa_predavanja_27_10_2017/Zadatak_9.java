 ...
 *  @author Edin Korkic
 *  
 *  Napisati program koji pita korisnika da unese daljinu u kilometrima koju želi preæi, potrošnju auta 
 *  (koliko kilometara može preæi sa litrom goriva), te cijenu litre goriva. Ispisati konaènu cijenu putovanja.
 *  Sample run programa:
 *  Unesite duzinu puta u kilometrima: 125
 *  Unesite potrosnju auta (koliko kilometara moze preci sa litrom goriva): 25
 *  Unesite cijenu litre goriva u markama: 2.5
