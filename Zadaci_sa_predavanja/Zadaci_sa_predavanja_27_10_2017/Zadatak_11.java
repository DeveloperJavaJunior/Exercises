 ...
 *  @author Edin Korkic
 *  
 *  Napisati program koji izraèunava energiju potrebnu za zagrijavanje vode od poèetne do
 *  željene temperature. Program treba da pita korisnika da unese iznos vode u kilogramima,
 *  poèetnu temperaturu vode te željenu temperaturu vode. Formula za izraèunavanje potrebne
 *  energije je:Q = M * (zeljenaTemperatura - pocetnaTemperatura) * 4184
 *  gdje M predstavlja težinu vode u kilogramima, temperature predstavljamo u celzijusima
 *  a energiju Q u joulima.
 *  Sample run programa:
